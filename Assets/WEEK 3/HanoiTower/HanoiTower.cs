...
public class HanoiTower : MonoBehaviour
{
    ...
    private void Update()
    {
        if (currentPeg == 1)
        {
            peg1Transform.gameObject.GetComponent<Image>().color = Color.red;
            peg2Transform.gameObject.GetComponent<Image>().color = Color.black;
            peg3Transform.gameObject.GetComponent<Image>().color = Color.black;
        }

        if (currentPeg == 2)
        {
            peg2Transform.gameObject.GetComponent<Image>().color = Color.red;
            peg1Transform.gameObject.GetComponent<Image>().color = Color.black;
            peg3Transform.gameObject.GetComponent<Image>().color = Color.black;
        }

        if (currentPeg == 3)
        {
            peg3Transform.gameObject.GetComponent<Image>().color = Color.red;
            peg1Transform.gameObject.GetComponent<Image>().color = Color.black;
            peg2Transform.gameObject.GetComponent<Image>().color = Color.black;
        }
